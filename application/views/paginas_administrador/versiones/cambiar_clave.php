            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control" id="clave_actual" name="clave_actual" placeholder="******" maxlength="20" style="border-color: #8bc34a">
                    </div>
                    <div class="form-group">
                        <label for="clave_nueva">Ingrese clave nueva:</label>
                        <input type="password" class="form-control" id="clave_nueva" name="clave_nueva" placeholder="******" maxlength="20" style="border-color: #8bc34a">
                    </div>
                </div>
                <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                        <label for="clave_repetir">Repetir clave nueva:</label>
                        <input type="password" class="form-control" id="clave_repetir" name="clave_repetir" placeholder="******" maxlength="20" style="border-color: #8bc34a">
                    </div>
                </div>
