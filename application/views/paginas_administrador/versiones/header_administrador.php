...
<html lang="es">
    ...
    <head>
        ...
        <script>
            var base_url = "http://blog.sofgem.cl/";
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12" style="color: #616161">
                                <p class="mb-0 ocultar-div" style="text-align: center">
                                    ...
                                    <a href="<?php base_url(); ?>cliente/cerrar_sesion" style="color: #616161"><i class="fa fa-ban"></i><strong> Cerrar Sesión</strong></a>
                                </p>
